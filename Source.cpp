    ...
    while (true)
    {
        ...
        case '3':
        {
            do
            {
                ...
                if (b.rows % 2 != 0 || b.columns % 2 != 0 || b.rows == 0 || b.columns == 0)
                {
                    SET_COLOR(4);
                    cout << "\n\t!! The height and width of table must be even number and greater than 0 !!";
                    Sleep(1500);
                    continue;
                }
                cout << "-Enter 1 to of Difficult mode: ";
                cin >> isDiff;
            } while (b.rows % 2 != 0 || b.columns % 2 != 0);
        }
        break;
